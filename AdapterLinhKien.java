...
public class AdapterLinhKien extends RecyclerView.Adapter<AdapterLinhKien.ViewHolderDienTu> {
    ...
    public void onBindViewHolder( ViewHolderDienTu holder, int position) {
        ...
        AdapterThuongHieuLon adapterThuongHieuLon = new AdapterThuongHieuLon(context, linhKien.getThuongHieus());
        ...
        AdapterTopChuotLinhKien adapterTopChuotLinhKien = new AdapterTopChuotLinhKien(context, linhKien.getSanPhams());
